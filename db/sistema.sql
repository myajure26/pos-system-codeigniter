...
-- -----------------------------------------------------
-- Table `sistema`.`alto_caucho`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema`.`alto_caucho` (
...
-- -----------------------------------------------------
-- Table `sistema`.`ancho_caucho`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema`.`ancho_caucho` (
...
CREATE TABLE IF NOT EXISTS `sistema`.`producto` (
  ...
  INDEX `fk_producto_alto_caucho2_idx` (`id_alto_caucho` ASC) VISIBLE,
  INDEX `fk_producto_ancho_caucho2_idx` (`id_ancho_caucho` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_producto_alto_caucho2`
    FOREIGN KEY (`id_alto_caucho`)
    REFERENCES `sistema`.`alto_caucho` (`id_alto_caucho`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_producto_ancho_caucho2`
    FOREIGN KEY (`id_ancho_caucho`)
    REFERENCES `sistema`.`ancho_caucho` (`id_ancho_caucho`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 1000
...
-- -----------------------------------------------------
-- Table `sistema`.`metodo_pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sistema`.`metodo_pago` (
...
CREATE TABLE IF NOT EXISTS `sistema`.`venta` (
  ...
  INDEX `fk_venta_metodo_pago2_idx` (`id_metodo_pago` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_venta_impuesto1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venta_metodo_pago2`
    FOREIGN KEY (`id_metodo_pago`)
    REFERENCES `sistema`.`metodo_pago` (`id_metodo_pago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 1000
