		...
		return DataTable::of($ProductModel->getProducts())
			...
			->add('Acciones', function($row){
				return '<div class="btn-list"> 
                            <button type="button" class="btnUpdate btn btn-sm btn-primary waves-effect" data-id="'.$row->id.'" data-type="products" data-bs-toggle="modal" data-bs-target="#updateModal">
