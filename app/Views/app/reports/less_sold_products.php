        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center
                    ...
                    <h4 class="mb-sm-0 font-size-18">Reportes de productos menos vendidos</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:
                                    void(0);">Administrar ventas</a></li>
                            <li class="breadcrumb-item active">Reportes de productos menos vendidos</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="card-title-desc">En este módulo podrás ver los productos menos vendidos.</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="mt-2 mb-4 col-md-6">
                                <input type="text" class="form-control range" placeholder="Selecciona una fecha" id="range" data-type="less_sold_products">
                            </div>
                            <div class="col-md-6 mt-2 mb-4 d-block mx-auto">
                                <button class="btn btn-success w-100" id="btn-report">Generar reporte de los productos menos vendidos</button>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td style='background-color:white; width:400px'>
                                    ...
                                    <div style='font-size:14px; text-align:left; line-height:15px; margin-left: 20px'>
                                        ...
                                        <br><br>
                                        <strong style='font-size: 23px'>Reporte de productos menos vendidos</strong>
                                        <br><br>
...
<script>
    tableConfig('/less_sold_products', '.datatable');
