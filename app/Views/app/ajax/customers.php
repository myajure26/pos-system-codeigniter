            ...
            <form class="custom-form" action="<?=base_url('customers/create')?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control name" id="name" placeholder="Introduce el nombre del cliente" name="name" required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control phone" id="phone" placeholder="Introduce el teléfono del cliente" name="phone" required>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <textarea class="form-control address" id="address" placeholder="Introduce la dirección del cliente" name="address" required cols="2"></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
