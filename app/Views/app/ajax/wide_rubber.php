        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center
                    ...
                    <h4 class="mb-sm-0 font-size-18">Ancho caucho</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:
                                    void(0);">Administrar inventario</a></li>
                            <li class="breadcrumb-item active">Ancho caucho</li>
                        </ol>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Administrar las medidas de ancho caucho</h4>
                        <p class="card-title-desc">En este módulo podrás ver, agregar, actualizar y eliminar las medidas de ancho caucho.</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="custom-form" action="<?=base_url('wideRubber/create')?>" method="POST">
                <div class="modal-body">
                    <div class="response"></div>
                    <div class="mb-3">
                        <label class="form-label">Medida</label>
                        <input type="number" class="form-control number" id="wideNumber" placeholder="Introduce el valor de la medida" name="wideNumber" required>
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="custom-form viewForm" action="<?=base_url('wideRubber/update')?>" method="POST">
                <div class="modal-body">
                    <div class="response"></div>
                    <input type="hidden" id="viewIdentification" name="identification" value="">
                    <div class="mb-3">
                        <label class="form-label">Medida</label>
                        <input type="number" class="form-control number" id="viewWideNumber" name="wideNumber" disabled required>
                        <div class="invalid-feedback"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
...
<script>
    tableConfig('/wideRubber/get', '.datatable');

    function viewWideRubber(data){
        $('#viewIdentification').val(data[0].id_ancho_caucho);
        $('#viewWideNumber').val(data[0].ancho_numero);
