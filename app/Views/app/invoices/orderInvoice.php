	...
	<table style="font-size:12px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="background-color:white; width:390px; padding: 5px;">
				...
				<p><strong>Proveedor:</strong> <?= $order[0]->proveedor_nombre?></p>
                <p><strong>Cédula/RIF:</strong> <?= $order[0]->ci_rif_proveedor?></p>
                <p><strong>Dirección:</strong> <?= $order[0]->direccion?></p>
			...
			<td style="background-color:white; width:150px; text-align:right; padding: 5px;">
				...
				<strong>Fecha:</strong> <?= date("d-m-Y", strtotime($order[0]->creado_en))?><br>
				<strong>Hora:</strong> <?= date("H:i:s", strtotime($order[0]->creado_en))?><br>
				<strong>Estado:</strong> 
                <?php 
                    switch( $order[0]->estado_pedido ){
                        case 0: 
		...
		<tr>
			...
			<td style="background-color:white; width:540px; padding: 5px;"> 
                <p><strong>Moneda:</strong> <?= $order[0]->moneda?></p>
            </td>

            <td style="background-color:white; width:150px; text-align:right; padding: 5px;">
			
                <p><strong>Usuario:</strong> <?= $order[0]->usuario?></p>
